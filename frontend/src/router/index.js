    ...
    children: [
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "groupMain" */ "@/components/layouts/GroupMain.vue"
          ),
      },
      {
        path: "create",
        ...
        component: () =>
          import(
            /* webpackChunkName: "groupCreate" */ "@/components/layouts/GroupCreate.vue"
          ),
      },
      {
        path: `:groupId`,
        ...
        component: () =>
          import(
            /* webpackChunkName: "GroupUser" */ "@/components/layouts/GroupUser.vue"
          ),
      },
      // 출석 관련 routes
      {
